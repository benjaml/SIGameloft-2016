    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += ((node_3529*v.normal)*1.0+-1.0);
...
////// Emissive:
                float3 emissive = ((pow(1.0-max(0,dot(normalDirection, viewDirection)),4.5)*0.7*_LightColor0.rgb)+(node_7051*0.2));
/// Final Color:
